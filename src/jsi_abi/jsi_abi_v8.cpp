...
struct jsi_config_s {
  ...
  // V8 experimental flags (passed to V8::SetFlagsFromCommandLine on first
  // platform init; ignored on subsequent runtimes per V8 design).
  bool sparkplug{false};
  bool predictable{false};
  bool optimize_for_size{false};
  bool always_compact{false};
  bool jitless{false};
...
extern const jsi_instrumentation_vtable g_instrumentation_vtable;
...
struct HandleWrapper : public jsi_pointer {
  ...
  HandleWrapper(v8::Isolate *iso, v8::Local<V8Type> local)
      : jsi_pointer{&pointerVt}, isolate(iso) {
    persistent.Reset(iso, local);
  }

  ~HandleWrapper() { persistent.Reset(); }

  v8::Local<V8Type> get() const { return persistent.Get(isolate); }
};
...
struct PropNameIdHandle : public jsi_pointer {
  ...
  v8::Local<v8::Value> get() const { return persistent.Get(isolate); }
};
...
struct WeakObjectHandle : public jsi_pointer {
  ...
  v8::Local<v8::Object> get() const { return persistent.Get(isolate); }
};
...
v8::Local<v8::Value> toV8Value(v8::Isolate *isolate, const jsi_value *val) {
  ...
  case jsi_valuekind_string:
    return static_cast<StringHandle *>(val->data.pointer)->get();
  case jsi_valuekind_symbol:
    return static_cast<SymbolHandle *>(val->data.pointer)->get();
  case jsi_valuekind_bigint:
    return static_cast<BigIntHandle *>(val->data.pointer)->get();
  case jsi_valuekind_object:
    return static_cast<ObjectHandle *>(val->data.pointer)->get();
  default:
    return v8::Undefined(isolate);
  }
}
  ...
  static void Enumerator(const v8::PropertyCallbackInfo<v8::Array> &info) {
    ...
    for (size_t i = 0; i < list->size; i++) {
      v8::Local<v8::Value> propValue =
          toPropNameIdHandle(list->props[i])->get();
...
JsiRuntimeState *JsiRuntimeState::create(const jsi_config_s *config) {
  ...
  if (useDefaults) {
    ...
    if (config->sparkplug)
      appendFlag("--sparkplug");
    if (config->predictable)
      appendFlag("--predictable");
    if (config->optimize_for_size)
      appendFlag("--optimize_for_size");
    if (config->always_compact)
      appendFlag("--always_compact");
    if (config->jitless)
      appendFlag("--jitless");
    if (config->lite_mode)
      appendFlag("--lite_mode");
  }
...
struct V8Scope {
  ...
  // isolate is shared across threads. Mirrors the legacy V8Runtime
  // IsolateLocker (V8JsiRuntime_impl.h).
...
jsi_propnameid JSI_CDECL jsi_clone_propnameid(jsi_runtime *rt,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::Value> v8val = toPropNameIdHandle(name)->get();
...
jsi_string JSI_CDECL jsi_clone_string(jsi_runtime *rt, jsi_string str) {
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::String> v8str = toStringHandle(str)->get();
...
jsi_symbol JSI_CDECL jsi_clone_symbol(jsi_runtime *rt, jsi_symbol sym) {
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::Symbol> v8sym = toSymbolHandle(sym)->get();
...
jsi_object JSI_CDECL jsi_clone_object(jsi_runtime *rt, jsi_object obj) {
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::Object> v8obj = toObjectHandle(obj)->get();
...
jsi_bigint JSI_CDECL jsi_clone_bigint(jsi_runtime *rt, jsi_bigint bigint) {
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::BigInt> v8bi = toBigIntHandle(bigint)->get();
...
bool JSI_CDECL jsi_prop_name_id_equals(jsi_runtime *rt, jsi_propnameid a,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::Value> va = toPropNameIdHandle(a)->get();
  v8::Local<v8::Value> vb = toPropNameIdHandle(b)->get();
...
jsi_bool_or_error JSI_CDECL jsi_has_object_property_from_propnameid(
  ...
  v8::Local<v8::Object> v8obj = toObjectHandle(obj)->get();
  v8::Local<v8::Value> v8name = toPropNameIdHandle(name)->get();
...
size_t JSI_CDECL jsi_get_array_length(jsi_runtime *rt, jsi_array arr) {
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::Object> v8obj = toObjectHandle({arr.pointer})->get();
  if (!v8obj->IsArray())
    return 0;
...
jsi_value_or_error JSI_CDECL jsi_get_array_element(jsi_runtime *rt,
  ...
  v8::Local<v8::Object> v8obj = toObjectHandle(arr)->get();
  v8::Local<v8::Value> val;
...
jsi_uint8_ptr_or_error JSI_CDECL jsi_get_arraybuffer_data(jsi_runtime *rt,
  ...
  v8::Local<v8::Object> v8obj = toObjectHandle({ab.pointer})->get();
...
jsi_value_or_error JSI_CDECL jsi_call(jsi_runtime *rt, jsi_function fn,
  ...
  v8::Local<v8::Object> v8obj = toObjectHandle({fn.pointer})->get();
  if (!v8obj->IsFunction()) {
...
jsi_value JSI_CDECL jsi_lock_weak_object(jsi_runtime *rt,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  v8::Local<v8::Object> v8obj = toWeakObjectHandle(wo)->get();
  if (v8obj.IsEmpty())
    return abi::create_undefined_value();
...
jsi_bool_or_error JSI_CDECL jsi_instance_of(jsi_runtime *rt, jsi_object obj,
  ...
  v8::Local<v8::Object> v8obj = toObjectHandle(obj)->get();
  v8::Local<v8::Object> v8ctor = toObjectHandle({ctor.pointer})->get();
...
bool JSI_CDECL jsi_strict_equals_symbol(jsi_runtime *rt, jsi_symbol a,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  return toSymbolHandle(a)->get()->StrictEquals(toSymbolHandle(b)->get());
}
...
bool JSI_CDECL jsi_strict_equals_bigint(jsi_runtime *rt, jsi_bigint a,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  return toBigIntHandle(a)->get()->StrictEquals(toBigIntHandle(b)->get());
}
...
bool JSI_CDECL jsi_strict_equals_string(jsi_runtime *rt, jsi_string a,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  return toStringHandle(a)->get()->StrictEquals(toStringHandle(b)->get());
}
...
bool JSI_CDECL jsi_strict_equals_object(jsi_runtime *rt, jsi_object a,
  ...
  auto *state = getState(rt);
  V8Scope scope(state);
  return toObjectHandle(a)->get()->StrictEquals(toObjectHandle(b)->get());
}
...
bool JSI_CDECL jsi_bigint_is_int64(jsi_runtime *rt, jsi_bigint bigint) {
  ...
  V8Scope scope(state);
  bool lossless = true;
  toBigIntHandle(bigint)->get()->Int64Value(&lossless);
  return lossless;
}
...
bool JSI_CDECL jsi_bigint_is_uint64(jsi_runtime *rt, jsi_bigint bigint) {
  ...
  V8Scope scope(state);
  bool lossless = true;
  toBigIntHandle(bigint)->get()->Uint64Value(&lossless);
  return lossless;
}
...
uint64_t JSI_CDECL jsi_bigint_truncate_to_uint64(jsi_runtime *rt,
  ...
  V8Scope scope(state);
  bool lossless = false;
  return toBigIntHandle(bigint)->get()->Uint64Value(&lossless);
}
...
int64_t JSI_CDECL jsi_bigint_to_int64(jsi_runtime *rt, jsi_bigint bigint,
  ...
  int64_t result = toBigIntHandle(bigint)->get()->Int64Value(&is_lossless);
  if (lossless)
...
uint64_t JSI_CDECL jsi_bigint_to_uint64(jsi_runtime *rt, jsi_bigint bigint,
  ...
  V8Scope scope(state);
  bool is_lossless = true;
  uint64_t result = toBigIntHandle(bigint)->get()->Uint64Value(&is_lossless);
  if (lossless)
    *lossless = is_lossless;
  return result;
}
...
jsi_string_or_error JSI_CDECL jsi_bigint_to_string(jsi_runtime *rt,
  ...
  v8::Local<v8::BigInt> bi = toBigIntHandle(bigint)->get();
...
void JSI_CDECL instr_release(void * /*inst*/) {
  // Instance is the JsiRuntimeState itself; do not delete.
}

void JSI_CDECL instr_get_recorded_gc_stats(void *inst,
                                            jsi_growable_buffer *buf) {
  auto *state = static_cast<JsiRuntimeState *>(inst);
  V8Scope scope(state);

  v8::HeapStatistics heapStats;
  state->isolate->GetHeapStatistics(&heapStats);

  std::stringstream json;
  json << "{\n";
  json << "  \"totalHeapSize\": " << heapStats.total_heap_size() << ",\n";
  json << "  \"totalHeapSizeExecutable\": "
  ...
  json << "  \"totalAvailableSize\": " << heapStats.total_available_size()
       << ",\n";
  json << "  \"totalGlobalHandlesSize\": "
       << heapStats.total_global_handles_size() << ",\n";
  json << "  \"usedGlobalHandlesSize\": "
       << heapStats.used_global_handles_size() << ",\n";
  ...
  json << "  \"doesZapGarbage\": " << (heapStats.does_zap_garbage() != 0)
       << ",\n";
  json << "  \"numberOfNativeContexts\": "
       << heapStats.number_of_native_contexts() << ",\n";
  json << "  \"numberOfDetachedContexts\": "
       << heapStats.number_of_detached_contexts() << "\n";
  json << "}";

  std::string result = json.str();
  writeToBuf(buf, result);
}

void JSI_CDECL instr_get_heap_info(
    void *inst, bool /*include_expensive*/,
  ...
  callback(user_data, "totalHeapSize",
           static_cast<int64_t>(heapStats.total_heap_size()));
  callback(user_data, "totalHeapSizeExecutable",
           static_cast<int64_t>(heapStats.total_heap_size_executable()));
  callback(user_data, "totalPhysicalSize",
           static_cast<int64_t>(heapStats.total_physical_size()));
  callback(user_data, "totalAvailableSize",
           static_cast<int64_t>(heapStats.total_available_size()));
  callback(user_data, "totalGlobalHandlesSize",
           static_cast<int64_t>(heapStats.total_global_handles_size()));
  callback(user_data, "usedGlobalHandlesSize",
           static_cast<int64_t>(heapStats.used_global_handles_size()));
  callback(user_data, "usedHeapSize",
           static_cast<int64_t>(heapStats.used_heap_size()));
  callback(user_data, "heapSizeLimit",
           static_cast<int64_t>(heapStats.heap_size_limit()));
  callback(user_data, "mallocedMemory",
           static_cast<int64_t>(heapStats.malloced_memory()));
  callback(user_data, "externalMemory",
           static_cast<int64_t>(heapStats.external_memory()));
  callback(user_data, "peakMallocedMemory",
           static_cast<int64_t>(heapStats.peak_malloced_memory()));
  callback(user_data, "doesZapGarbage",
           static_cast<int64_t>(heapStats.does_zap_garbage()));
  callback(user_data, "numberOfNativeContexts",
           static_cast<int64_t>(heapStats.number_of_native_contexts()));
  callback(user_data, "numberOfDetachedContexts",
           static_cast<int64_t>(heapStats.number_of_detached_contexts()));
}

void JSI_CDECL instr_collect_garbage(void *inst, const char * /*cause*/) {
  auto *state = static_cast<JsiRuntimeState *>(inst);
  state->isolate->LowMemoryNotification();
}

void JSI_CDECL instr_start_tracking_heap_object_stack_traces(void * /*inst*/) {}
void JSI_CDECL instr_stop_tracking_heap_object_stack_traces(void * /*inst*/) {}

void JSI_CDECL instr_start_heap_sampling(void *inst,
                                          size_t sampling_interval) {
  auto *state = static_cast<JsiRuntimeState *>(inst);
  v8::HeapProfiler *profiler = state->isolate->GetHeapProfiler();
  if (profiler)
    profiler->StartSamplingHeapProfiler(
        static_cast<uint64_t>(sampling_interval), 64);
}

void JSI_CDECL instr_stop_heap_sampling(
    void *inst,
  ...
  // V8 Debug DCHECK requires the isolate to be entered before TakeHeapSnapshot
  // (heap->isolate() == Isolate::TryGetCurrent()). Release builds don't enforce
  // it but Debug does.
  ...
  if (profile) {
    ...
    callback(user_data, result.c_str(), result.size());
  } else {
    callback(user_data, "{}", 2);
  }
  profiler->StopSamplingHeapProfiler();
}

void JSI_CDECL instr_create_snapshot_to_file(void *inst, const char *path,
  ...
  if (file_stream.is_open()) {
    ...
    public:
      explicit FileOutputStream(std::ofstream &os) : os_(os) {}
      WriteResult WriteAsciiChunk(char *data, int size) override {
        os_.write(data, size);
        return kContinue;
      }
      void EndOfStream() override { os_.flush(); }
...
void JSI_CDECL instr_create_snapshot_to_stream(
    void *inst, bool capture_numeric_value,
    void(JSI_CDECL *callback)(void *user_data, const char *data, size_t size),
    void *user_data) {
  auto *state = static_cast<JsiRuntimeState *>(inst);
  v8::HeapProfiler *profiler = state->isolate->GetHeapProfiler();
  ...
  class CallbackOutputStream : public v8::OutputStream {
  public:
    CallbackOutputStream(
        void(JSI_CDECL *cb)(void *, const char *, size_t), void *ud)
        : callback_(cb), user_data_(ud) {}
    WriteResult WriteAsciiChunk(char *data, int size) override {
      callback_(user_data_, data, static_cast<size_t>(size));
      return kContinue;
    }
    void EndOfStream() override {}

  private:
    void(JSI_CDECL *callback_)(void *, const char *, size_t);
    void *user_data_;
  } stream(callback, user_data);
  snapshot->Serialize(&stream, v8::HeapSnapshot::kJSON);
  const_cast<v8::HeapSnapshot *>(snapshot)->Delete();
}

void JSI_CDECL instr_flush_and_disable_bridge_traffic_trace(
    void * /*inst*/, jsi_growable_buffer * /*buf*/) {
  // Not supported for V8
}

void JSI_CDECL
instr_write_basic_block_profile_trace_to_file(void * /*inst*/,
                                               const char * /*path*/) {
  // Not supported for V8
}

void JSI_CDECL instr_dump_opcode_stats(
    void * /*inst*/,
    void(JSI_CDECL * /*callback*/)(void *, const char *, size_t),
    void * /*user_data*/) {
  // Not supported for V8
}

void JSI_CDECL instr_dump_profiler_symbols_to_file(void * /*inst*/,
                                                    const char * /*path*/) {
  // Not supported for V8
}

const jsi_instrumentation_vtable g_instrumentation_vtable = {
    /* version */ 1,
    /* reserved */ 0,
    /* release */ instr_release,
    /* get_recorded_gc_stats */ instr_get_recorded_gc_stats,
    /* get_heap_info */ instr_get_heap_info,
    /* collect_garbage */ instr_collect_garbage,
    /* start_tracking_heap_object_stack_traces */
    instr_start_tracking_heap_object_stack_traces,
    /* stop_tracking_heap_object_stack_traces */
    instr_stop_tracking_heap_object_stack_traces,
    /* start_heap_sampling */ instr_start_heap_sampling,
    /* stop_heap_sampling */ instr_stop_heap_sampling,
    /* create_snapshot_to_file */ instr_create_snapshot_to_file,
    /* create_snapshot_to_stream */ instr_create_snapshot_to_stream,
    /* flush_and_disable_bridge_traffic_trace */
    instr_flush_and_disable_bridge_traffic_trace,
    /* write_basic_block_profile_trace_to_file */
    instr_write_basic_block_profile_trace_to_file,
    /* dump_opcode_stats */ instr_dump_opcode_stats,
    /* dump_profiler_symbols_to_file */ instr_dump_profiler_symbols_to_file,
};
...
JSI_API const jsi_vtable *JSI_CDECL get_jsi_abi_v8_vtable() {
  static const jsi_vtable abiVtable = {
      /* version */ 1,
      /* reserved */ 0,
